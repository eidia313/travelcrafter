        ...
        @if(count($pages) > 0)
            <table class="table dash-table">
                ...
                @foreach($pages as $page)
                    <tr>
                        <td width="90">
                            <img src="{{URL::to('storage_old'.$page->image)}}" alt="{{$page->title}}" width="50">
                        </td>
                        <td>{{$page->title}}</td>
                        <td>
                            <ul class="action">
                                ...
                                <li>
                                    <a data-url="{{route('pages.destroy', $page->id)}}" data-name="{{$page->name}}" href="#" class="delete-this" data-toggle="modal" data-target="#exampleModal">
                                        <i class="tc-delete"></i>
                                    </a>
                                </li>
                            </ul>
