...
@section('addButton')
<a href="{{route('placetype.create', $activity)}}" class="btn btn-default">Add New</a>
@endsection
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <ul class="action">
                        <li>
                            <a href="{{route('placetype.edit', [$activity, $pt->id])}}">
                                <i class="tc-edit"></i>
                            </a>
                        </li>
                        <li>
                            <a data-url="{{route('placetype.destroy', [$activity, $pt->id])}}" data-name="{{$pt->name}}"
                                href="#" class="delete-this" data-toggle="modal" data-target="#exampleModal">
                                <i class="tc-delete"></i>
                            </a>
                        </li>
                    </ul>
