          ...
          <div class="package__desc">
            <div class="tab">
              <div class="tab__list tab__list--inner">
                <ul class="nav">
                  <li class="nav-item">
                    <a class="nav-link active" id="all-region-tab" data-toggle="tab" href="#all-region">All</a>
                  </li>
                  @foreach($regions as $k=>$r)
                  <li class="nav-item">
                    <a class="nav-link" id="region-{{$k}}-tab" data-toggle="tab" href="#region-{{$k}}">{{$r->name}}</a>
                  </li>
                  @endforeach
                </ul>
              </div>
                ...
                <div class="tab-pane fade" id="region-{{$k}}">
                  <div class="row">
                    ...
                    <div class="col-lg-4 ">
                      <div class="package__item">
                        <figure>
                          <img src="{{url('storage/images')}}/{{$pkg->cover_image}}" alt="{{$pkg->title}}">
                        </figure>
                        <div class="package__item--det">
                          <h3>
                        ...
                        <div class="package__item--meta d-inline-flex">
                          <div class="package__item--days">
                            <span class="package__item--days--title">Duration</span>
                            <span class="package__item--days--value">{{sizeof(json_decode($pkg->itenerary))}} Days</span>
                          </div>
                          <div class="package__item--difficulty">
                            <span class="package__item--difficulty--title">Difficulty</span>
                            <span class="package__item--difficulty--value">Strenous</span>
            ...
            <div class="tab">
              <div class="tab__list tab__list--inner">
                <ul class="nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link {{$k==0 ? 'active': ''}}" id="difficulty-{{$k}}-tab" data-toggle="tab" href="#difficulty-{{$k}}">{{$d->name}}</a>
                  </li>
                  @endforeach
                </ul>
              </div>
                    ...
                    <div class="col-lg-4">
                      <div class="package__item">
                        ...
                        <div class="package__item--meta d-inline-flex">
                          ...
                          <div class="package__item--difficulty">
                            <span class="package__item--difficulty--title">Difficulty</span>
                            <span class="package__item--difficulty--value">{{$pkg->difficulty->name}}</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="package__desc">
            <div class="tab">
              <div class="tab__list tab__list--inner">
                <ul class="nav">
                  <li class="nav-item">
                    <a class="nav-link active" id="duration-ten-tab" data-toggle="tab" href="#duration-ten">Less than 10 days</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="duration-twenty-tab" data-toggle="tab" href="#duration-twenty">10 to 20 days</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="duration-morethantwenty-tab" data-toggle="tab" href="#duration-morethantwenty">More than 20 days</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="tab">
              <div class="tab-content">
                ...
                <div class="tab-pane fade" id="duration-twenty">
                  <div class="row">
                    @foreach($packages as $pkg)
                      @if(sizeof(json_decode($pkg->itenerary)) >= 10 && sizeof(json_decode($pkg->itenerary)) < 20)
                        <div class="col-lg-4">
                          <div class="package__item">
                            <figure>
                              <img src="{{url('storage_old')}}/{{$pkg->cover_image}}" alt="{{$pkg->title}}">
                            </figure>
                            <div class="package__item--det">
                              <h3>
                                <a href="{{url('package')}}/{{$pkg->slug}}">{{$pkg->title}}</a>
