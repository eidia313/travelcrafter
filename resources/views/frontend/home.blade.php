                ...
                <div class="col-md-4">
                    <div class="activity__wrap--list">
                        <a href="{{url('tailor-made-trip')}}">
                            <figure>
                                <img src="{{url('frontend/images/')}}/tailormade.jpg" alt="{{$a->name}}" height="200"
...
<section class="tailormadetrip">
    <div class="container">
        <div class="tailormadetrip__detail">
            ...
            <p>The itineraries that we have listed on our website are just the most popular ones, but it does not mean
                we only operate such fixed programs. On these essential routes, we give you exciting opportunities to
                create, add or combine your own tailor-made itineraries to our tours.</p>
...
<section class="instagram">
    <div class="section-heading text-center">
        ...
        <p>Follow our instagram handle <a href="https://www.instagram.com/{{$settings->instagram}}"
                target="_blank">{{"@"}}{{$settings->instagram}}</a> to see wonders of Nepal</p>
    </div>
...
<section class="promovideo">
    <div class="container">
        <div class="section-heading text-center">
            <h2>Promo Video</h2>
            <p>Follow our <a href="https://www.youtube.com/{{$settings->youtube}}" target="_blank">YouTube</a> channel
                for sneak peak of Himalayas.</p>
        </div>
        <div class="video__wrap promovideo__wrap">
            <iframe width="560" height="215" src="https://www.youtube.com/embed/{{$settings->promovideo}}"
    ...
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                ...
                <p>We are not just a company for adventurous trekkers, for us giving back to the community is just as
                    important. We have partnered with international social companies to do as much social work as we can
                    in different parts of Nepal</p>
            </div>
        </div>
    </div>
</section>
